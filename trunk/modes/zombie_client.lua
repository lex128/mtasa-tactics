...
function ZombieMod_onClientZombieInfected()
	...
	if (source == localPlayer) then
		setPlayerProperty("movespeed",tonumber(getTacticsData("modes","zombie","zombie_speed")) or 1.2)
		setPlayerProperty("regenerable",tonumber(getTacticsData("modes","zombie","zombie_regenerate")) or 5)
